 ...
 * improvement over the real Avec Pro app's own date picker, which has no such shortcuts.
 *
...
function renderDayGrid(
	...
	monthLabel.className = 'avec-clone-datepicker__nav-label';

	const yearLabel = navButton( String( year ), () =>
		renderYearGrid( panel, year, month, selectedIso, onPick )
	);
	yearLabel.className = 'avec-clone-datepicker__nav-label';

	const label = document.createElement( 'span' );
	label.className = 'avec-clone-datepicker__nav-labels';
...
function renderMonthGrid(
	...
	const grid = document.createElement( 'div' );
	grid.className =
		'avec-clone-datepicker__grid avec-clone-datepicker__grid--months';
...
function renderYearGrid(
	...
	const label = document.createElement( 'span' );
	label.className = 'avec-clone-datepicker__nav-label';
	...
	const grid = document.createElement( 'div' );
	grid.className =
		'avec-clone-datepicker__grid avec-clone-datepicker__grid--years';
