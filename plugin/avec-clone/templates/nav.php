 ...
 * template. The real Avec Pro app uses a hamburger/off-canvas nav at every breakpoint (not just
...
<div class="avec-clone-topbar">
	...
	<?php if ( 'agenda' === $current_section ) : ?>
		<span class="avec-clone-topbar__title avec-clone-topbar__title--selector">
			<?php echo esc_html( $current_user->display_name ); ?> <span aria-hidden="true">&#8964;</span>
		</span>
	<?php else : ?>
		<span class="avec-clone-topbar__title">
...
<nav class="avec-clone-nav" id="avec-clone-nav" aria-label="<?php esc_attr_e( 'Navegação do painel', 'avec-clone' ); ?>">
	<div class="avec-clone-nav__user">
		...
		<a class="avec-clone-nav__edit-profile" href="<?php echo esc_url( admin_url( 'profile.php' ) ); ?>">
			<?php esc_html_e( 'Editar perfil', 'avec-clone' ); ?>
	...
	<ul class="avec-clone-nav__list">
		...
		<li class="avec-clone-nav__item">
			<a href="<?php echo esc_url( wp_logout_url( home_url( '/' ) ) ); ?>">
				...
				<?php esc_html_e( 'Sair', 'avec-clone' ); ?>
			</a>
		</li>
	</ul>
</nav>
