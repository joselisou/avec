...
<div class="avec-clone-login">
	...
	<div class="avec-clone-login__form-panel">
		...
		<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php?action=avec_clone_login' ) ); ?>">
			...
			<div class="avec-clone-password-field">
				<input type="password" name="pwd" id="avec-clone-pwd" placeholder="<?php esc_attr_e( 'Digite sua senha...', 'avec-clone' ); ?>" required />
				<button type="button" class="avec-clone-password-field__toggle" data-avec-password-toggle="avec-clone-pwd" aria-label="<?php esc_attr_e( 'Mostrar senha', 'avec-clone' ); ?>">
					<svg class="avec-clone-eye-icon" viewBox="0 0 1024 1024" aria-hidden="true">
						...
						<line class="avec-clone-eye-icon__slash" x1="120" y1="120" x2="904" y2="904" />
					</svg>
				</button>
			</div>
