 ...
 * Expects the including template to set `$avec_back_url` and `$avec_back_title` first.
 *
 * @package AvecClone
 */
...
<div class="avec-clone-topbar">
	<a href="<?php echo esc_url( $avec_back_url ); ?>" class="avec-clone-back-arrow" aria-label="<?php esc_attr_e( 'Voltar', 'avec-clone' ); ?>">
	...
	<span class="avec-clone-topbar__title"><?php echo esc_html( $avec_back_title ); ?></span>
	<span class="avec-clone-topbar__action"></span>
</div>
