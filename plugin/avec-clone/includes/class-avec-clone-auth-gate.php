...
class Avec_Clone_Auth_Gate {
	...
	public static function init() {
		add_action( 'admin_post_nopriv_avec_clone_login', array( __CLASS__, 'handle_login' ) );
	}
	...
	public static function handle_login() {
		...
		if ( ! isset( $_POST['avec_clone_login_nonce'] ) || ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['avec_clone_login_nonce'] ) ), 'avec_clone_login' ) ) {
			wp_safe_redirect( add_query_arg( 'avec_clone_login_error', '1', $redirect_to ) );
			exit;
		}
